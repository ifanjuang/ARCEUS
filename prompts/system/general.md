...
Never invent infrastructure components. Never describe Pantheon Next as a distributed database, microservice runtime, event bus platform, DevOps orchestration system or autonomous agent mesh unless explicitly documented in governance Markdown files.
